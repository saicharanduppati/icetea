// Generated by Bisonc++ V4.05.00 on Wed, 25 Mar 2015 15:25:01 +0530
...
// $insert polymorphicSpecializations
    ...
    {
        static Tag__ const tag = Tag__::stringTag;
    };

    template <>
    struct TagOf<std::list<abstractAST*>>
    {
        static Tag__ const tag = Tag__::listTag;
    };

    template <>
    struct TagOf<abstractAST*>
    {
        static Tag__ const tag = Tag__::ast;
    };

    template <>
    struct TypeOfBase<Tag__::stringTag>
    {
        typedef std::string DataType;
    };

    template <>
    struct TypeOfBase<Tag__::listTag>
    {
        typedef std::list<abstractAST*> DataType;
    };

    template <>
    struct TypeOfBase<Tag__::ast>
    {
        typedef abstractAST* DataType;
    };
